...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
        .sendForm('service_bdz5j0y', 'template_jja181e', form.current, {
                ...
                <div className="contact_info">
                    <div className="contact_card">
                        ...
                        <span className="contact_card-data">
                            varungawali47@gmail.com
                        </span>

                        <a href="mailto:varungawali47@gmail.com.com" className="contact_button">
                    ...
                    <div className="contact_card">
                        ...
                        <a href="https://api.whatsapp.com/send?phone=8624999432&text=Hello, more information!" className="contact_button">
                            Write me <i className="bx bx-right-arrow-alt contact_button-icon"></i>
                        </a>
                    </div>
                    ...
                    <div className="contact_card">
                        ...
                        <h3 className="contact_card-title">X</h3>
                        <span className="contact_card-data">
                            @VarunGawali
                        </span>
